...
public class SampleMail {
    ...
    public static void main(String[] args) {
        ...
        props.put("mail.user", "noreply@mdkmed.cn");
        // 访问SMTP服务时需要提供的密码(在控制台选择发信地址进行设置)
        props.put("mail.password", "MDKMED.2017");
...
//        mailSession.setDebug(true);
        ...
        try {
            ...
            InternetAddress from = new InternetAddress("noreply@mdkmed.cn", "admin");
...
//            message.setReplyTo(a);
            ...
            InternetAddress to = new InternetAddress("zhangpeng@mdkmed.cn");
